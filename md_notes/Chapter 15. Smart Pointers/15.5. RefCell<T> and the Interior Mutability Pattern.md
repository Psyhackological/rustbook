## [`RefCell<T>` and the Interior Mutability Pattern](https://doc.rust-lang.org/nightly/book/ch15-05-interior-mutability.html#refcellt-and-the-interior-mutability-pattern)
...
### [Enforcing Borrowing Rules at Runtime with `RefCell<T>`](https://doc.rust-lang.org/nightly/book/ch15-05-interior-mutability.html#enforcing-borrowing-rules-at-runtime-with-refcellt)
...
### [Interior Mutability: A Mutable Borrow to an Immutable Value](https://doc.rust-lang.org/nightly/book/ch15-05-interior-mutability.html#interior-mutability-a-mutable-borrow-to-an-immutable-value)
...
#### [A Use Case for Interior Mutability: Mock Objects](https://doc.rust-lang.org/nightly/book/ch15-05-interior-mutability.html#a-use-case-for-interior-mutability-mock-objects)
