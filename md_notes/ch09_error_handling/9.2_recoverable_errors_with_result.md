## [Recoverable Errors with `Result`](https://doc.rust-lang.org/nightly/book/ch09-02-recoverable-errors-with-result.html#recoverable-errors-with-result)
...
### [Matching on Different Errors](https://doc.rust-lang.org/nightly/book/ch09-02-recoverable-errors-with-result.html#matching-on-different-errors)
...
### [Alternatives to Using `match` with `Result<T, E>`](https://doc.rust-lang.org/nightly/book/ch09-02-recoverable-errors-with-result.html#alternatives-to-using-match-with-resultt-e)
...
### [Shortcuts for Panic on Error: `unwrap` and `expect`](https://doc.rust-lang.org/nightly/book/ch09-02-recoverable-errors-with-result.html#shortcuts-for-panic-on-error-unwrap-and-expect)
...
### [Propagating Errors](https://doc.rust-lang.org/nightly/book/ch09-02-recoverable-errors-with-result.html#propagating-errors)
...
#### [A Shortcut for Propagating Errors: the `?` Operator](https://doc.rust-lang.org/nightly/book/ch09-02-recoverable-errors-with-result.html#a-shortcut-for-propagating-errors-the--operator)
...
#### [Where The `?` Operator Can Be Used](https://doc.rust-lang.org/nightly/book/ch09-02-recoverable-errors-with-result.html#where-the--operator-can-be-used)
