## [Publishing a Crate to Crates.io](https://doc.rust-lang.org/nightly/book/ch14-02-publishing-to-crates-io.html#publishing-a-crate-to-cratesio)
...
### [Making Useful Documentation Comments](https://doc.rust-lang.org/nightly/book/ch14-02-publishing-to-crates-io.html#making-useful-documentation-comments)
...
#### [Commonly Used Sections](https://doc.rust-lang.org/nightly/book/ch14-02-publishing-to-crates-io.html#commonly-used-sections)
...
#### [Documentation Comments as Tests](https://doc.rust-lang.org/nightly/book/ch14-02-publishing-to-crates-io.html#documentation-comments-as-tests)
...
#### [Commenting Contained Items](https://doc.rust-lang.org/nightly/book/ch14-02-publishing-to-crates-io.html#commenting-contained-items)
...
For example, to add documentation that describes the purpose of the `my_crate` crate that contains the `add_one` function, we add documentation comments that start with `//!` to the beginning of the _src/lib.rs_ file
...
### [Exporting a Convenient Public API with `pub use`](https://doc.rust-lang.org/nightly/book/ch14-02-publishing-to-crates-io.html#exporting-a-convenient-public-api-with-pub-use)
...
For example, say we made a library named `art` for modeling artistic concepts. Within this library are two modules: a `kinds` module containing two enums named `PrimaryColor` and `SecondaryColor` and a `utils` module containing a function named `mix`
...
### [Setting Up a Crates.io Account](https://doc.rust-lang.org/nightly/book/ch14-02-publishing-to-crates-io.html#setting-up-a-cratesio-account)
...
### [Adding Metadata to a New Crate](https://doc.rust-lang.org/nightly/book/ch14-02-publishing-to-crates-io.html#adding-metadata-to-a-new-crate)
...
### [Publishing to Crates.io](https://doc.rust-lang.org/nightly/book/ch14-02-publishing-to-crates-io.html#publishing-to-cratesio)
...
### [Publishing a New Version of an Existing Crate](https://doc.rust-lang.org/nightly/book/ch14-02-publishing-to-crates-io.html#publishing-a-new-version-of-an-existing-crate)
...
### [Deprecating Versions from Crates.io with `cargo yank`](https://doc.rust-lang.org/nightly/book/ch14-02-publishing-to-crates-io.html#deprecating-versions-from-cratesio-with-cargo-yank)
